...
import logo from "../../images/logo/orange_logo.png";
        ...
        <div className="footer_box">
          <div className="footer_box_links">
            ...
            <div className="footer_links">
              <div className="links_fon">
                <p className="links_fon_text">Номер для заказа</p>
                <a href="tel:+79308333811" className="links_fon_link">
                  <img src={call} />
                  +7(930)833-38-11
                </a>
              </div>
              <div className="links_network">
                <p className="links_network_text">Мы в соцсетях</p>
                <div className="links_network_social">
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 36 36"
